...
def test_example(page: Page) -> None:
    ...
    page.locator(".MuiInputBase-colorPrimary.MuiInputBase-root.css-upw9vt.input > input[name='login']").fill("1createManagerByAdmin")
    ...
    page.locator("//html/body/div[2]/div[3]/div/div/div[2]/form/fieldset/div[1]/div[5]/div[2]/div/div/div[1]/div[2]/input").fill("Менеджер")
    '''press enter'''
    ...
    time.sleep(3)
    ''''''
    expect(page.locator(".MuiInputBase-colorPrimary.MuiInputBase-root.css-upw9vt.input > input[name='login']")).to_have_value("1createManagerByAdmin")
    ...
    expect(page.locator('//*[@id="root"]/div/div[2]/div[2]/div/div[1]/div/div[1]/p[2]')).to_have_text("1createManagerByAdmin")
    expect(page.get_by_text("Менеджер")).to_have_count(1)
