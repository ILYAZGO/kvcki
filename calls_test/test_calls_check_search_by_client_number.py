...
def test_example(page: Page) -> None:
    ...
    ''''''
    page.locator('//html/body/div/div/div[2]/div[2]/div/div/div[2]/div[1]/div/div[1]/div[2]/div/div/div/div/div/div[1]/div/div[1]/div/div/div/div/div/div/div[1]/div[2]/input').fill("79251579005")
    '''naity zvonki'''
    page.locator('//html/body/div/div/div[2]/div[2]/div/div/div[2]/div[1]/div/div[2]/div/button').click()
    '''check'''
    expect(page.locator('//*[@id="root"]/div/div[2]/div[2]/div/div/div[3]/div[1]/div/p')).to_have_text("Найдено звонков 14 из 3130")
