...
def test_example(page: Page) -> None:
    ...
    '''fill client number'''
    page.locator('//html/body/div/div/div/div[2]/div/div/div[2]/div[1]/div/div[1]/div[2]/div/div/div/div/div/div[1]/div/div[1]/div/div/div/div/div/div/div[1]/div[2]/input').fill("79251579005")
    '''naity zvonki'''
