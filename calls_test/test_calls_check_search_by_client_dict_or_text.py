...
def test_example(page: Page) -> None:
    ...
    time.sleep(75)
    '''check'''
    expect(page.locator('//*[@id="root"]/div/div/div[2]/div/div/div[3]/div[1]/div/p')).to_have_text("Найдено звонков 152 из 3130")
    '''choose dict'''
    page.locator('//*[@id="react-select-6-input"]').clear()
    page.locator('//*[@id="react-select-6-input"]').fill("Зо")
    ...
    expect(page.locator('//*[@id="root"]/div/div/div[2]/div/div/div[3]/div[1]/div/p')).to_have_text("Найдено звонков 410 из 3130")