BUTTON_POLZOVATELI = "#root > div > div.AdminBar_root__ieqog > a"
BUTTON_DOBAVIT_POLZOVATELIA = ".header-left-flex [tabindex]"
BUTTON_OTMENA = "//html/body/div[2]/div[3]/div/div/div[2]/form/div/button[1]"
BUTTON_KRESTIK = "CloseIcon"
BUTTON_DOBAVIT = "//html/body/div[2]/div[3]/div/div/div[2]/form/div/button[2]"
...
BUTTON_DOBAVIT_SOTRUDNIKA = "(//button[contains(text(),'Добавить сотрудника')])[1]"
BUTTON_SOTRUDNIKI_DOBAVIT = "button[class='MuiButtonBase-root MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeMedium MuiButton-containedSizeMedium MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeMedium MuiButton-containedSizeMedium css-17awxj7']"
BUTTON_SOTRUDNIKI_UDALIT = "//button[contains(text(),'Удалить')]"
BUTTON_SOTRUDNIKI_KORZINA = ".styles_actions__6AFGJ"

INPUT_POISK = "input[name='searchString']"
...
INPUT_COMMENT = "textarea[name='comment']"
...
CHOOSE_ROLE = "//html/body/div[2]/div[3]/div/div/div[2]/form/fieldset/div[1]/div[5]/div[2]/div/div/div[1]/div[2]/input"
