...
first_day_month_ago = (current_date - timedelta(days=30)).strftime("%d/%m/%Y") #(current_date + relativedelta(weeks=-4)).strftime("%d/%m/%Y")                   #(current_date - timedelta(days=30)).strftime("%d/%m/%Y")
